...
export default function Contact() {
  ...
  return (
    <div className='mx-auto rounded-3xl relative h-[75vh] hide-scroll overflow-y-scroll z-10 w-[70vw]'>
            ...
            <motion.img initial={{y:0}} animate={{y:0}} transition={{duration:9, repeat:Infinity, repeatType:'reverse'}} className='w-full h-full rounded-3xl absolute -z-10' src="/bg7.jpg" alt="" />
            ...
            <section className='flex h-full gap-9 poppins justify-center items-center'>
              <form className='flex justify-center items-center gap-2 w-full h-1/2' action="mailto:vaisuro45@gmail.com" method='post'>
                <textarea className=' m-5 h-full w-1/2 border-[1px] focus:outline-none border-white text-white p-5 rounded-3xl bg-transparent '></textarea>
                <div className=' text-neutral-300 flex flex-col justify-between h-full gap-8'>
                    <h1 className='font-medium text-2xl flex gap-2 items-center'>Send a message</h1>
