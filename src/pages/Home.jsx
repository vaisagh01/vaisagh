  ...
  return (
    ...
    >
      <div data-scroll-container ref={container} className='bg-neutral-900 overflow-hidden hide-scroll'>        
        ...
        {/* <motion.div style={{scaleY: scrollYProgress}} className='w-[2px] rounded-full bg-slate-100 fixed top-32 right-10 h-96 origin-top'></motion.div> */}

        <div data-scroll-container data-scroll-speed="3" ref={container}  className='flex flex-col items-center justify-center gap-32'>
