    ...
    return (
      ...
      <div className='bg-neutral-900'>        
        <div  ref={container}  className='flex flex-col items-center poppins text-neutral-400'>
          ...
          <motion.section className='pt-24 flex  flex-col gap-10 sticky top-0 h-screen' style={{scale:title}} initial={{y:0,scale:1.3, opacity:0}} animate={{y:0,scale:1, opacity:1}} transition={{duration:1.4,delay:0.5,ease:[0.76,0,0.24,1]}}  >
              <div className='flex justify-between'>
                <p>2004</p>
                <p className='text-xl pacifico '>Hello!</p>
                <p className='flex'><MapPin /> Bangalore</p>
              </div>
              <motion.h1 
              ...
              <div className='flex justify-between'>
                <NavLink to={'/about'}
                  className={'hover:border-b-[1px] hover:border-slate-400 transition-all duration-300'} >know more about me?
                </NavLink>
          ...
          <motion.section className='sticky border-t-[1px] border-neutral-500 top-0 bg-neutral-900' style={{scale:sm1}} initial={{y:0,scale:0.9, opacity:0}} animate={{y:0,scale:1, opacity:1}} transition={{duration:1.4,ease:[0.76,0,0.24,1]}}  >
            <Landing/>
          </motion.section>
          ...
          <div className='text-8xl border-t-[1px] border-neutral-500 bg-neutral-900 w-full sticky top-[0vh] h-screen uppercase font-semibold text-neutral-400'>
              <p className='mt-52 text-center'>My Top #3 projects</p>
          </div>
