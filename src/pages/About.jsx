  ...
  return (
    <div className='bg-neutral-900 pt-28 h-screen overflow-hidden hide-scroll'>        
      <div className='w-3/4 mx-auto text-xl poppins text-neutral-400'>
        <motion.h1 initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{duration:0.9,delay:0.7,ease:[0.76,0,0.24,1]}}  className='text-4xl border-b-[1px] border-neutral-700 text-violet-600 pb-10 '>About</motion.h1>
        <div className='pt-1 flex border-b-[1px] border-neutral-700 pb-14 items-start justify-between'>
          <div>
          ...
          <div>
            ...
            <motion.h1 initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{duration:0.6,delay:0.3,ease:[0.76,0,0.24,1]}} >hello</motion.h1>
            <motion.h1 initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{duration:0.6,delay:0.4,ease:[0.76,0,0.24,1]}} >hello</motion.h1>
          </div>
        </div>
        <div className='pt-1'>
          <motion.h1 initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{duration:0.6,delay:0.6,ease:[0.76,0,0.24,1]}}  className='pb-10'>What are my skills?</motion.h1>
